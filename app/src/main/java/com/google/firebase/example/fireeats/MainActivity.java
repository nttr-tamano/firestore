...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int LIMIT = 15; //50;

    // ButterKnife
    // http://www.tsurutan.com/entry/2016/05/06/183621
    ...
    public void onFilter(Filters filters) {
        ...
        if (filters.hasCategory()) {
            //Log.d("filter","filters.getCategory()="+filters.getCategory());
            query = query.whereEqualTo("category", filters.getCategory());
        }

        // City (equality filter)
        if (filters.hasCity()) {
            //Log.d("filter","filters.getCity()="+filters.getCity());
            query = query.whereEqualTo("city", filters.getCity());
        }

        // Price (equality filter)
        if (filters.hasPrice()) {
            //Log.d("filter","filters.getPrice()="+filters.getPrice());
